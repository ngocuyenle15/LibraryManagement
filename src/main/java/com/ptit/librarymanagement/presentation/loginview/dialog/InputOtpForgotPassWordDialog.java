...
public class InputOtpForgotPassWordDialog extends JDialog {
    ...
    private InputForm optInput;




    public InputOtpForgotPassWordDialog(Frame owner, boolean modal, String title, String type) {
...
//        idInput = new JTextField("");
        ...
        optInput = new InputForm("OTP");
            mainPanel.add(optInput);
